        ...
        <Layout className={'layout-home'}>
            <Group className="flex h-full max-h-svh overlay " gd={{overflow:"hidden", height: '100vh'}}>
                <RenderIf isTrue={true}>
                    <Sidebar ref={elementRefSideBar} gd={{ marginBottom: (positionFooter.bottom - positionFooter.top) }} className="overflow-auto hidden md:!flex backdrop-blur bg-opacity-80">
